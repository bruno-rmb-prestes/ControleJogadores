<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncluirAtleta.aspx.cs" Inherits="ControleJogadores.Create" %>
...
<asp:Button ID="btnSave" runat="server" Text="Incluir" OnClick="btnSave_Click" />
    </form>
